...
const SWEDISH_CITIES_CACHE: GeocodingCache = {
	...
	// Göteborg area - batch distance discoveries
	'hisings backa': { latitude: 57.7500, longitude: 11.9833, displayName: 'Hisings Backa', city: 'Göteborg', country: 'Sweden', fetchedAt: '2024-01-01' },
	'mölnlycke': { latitude: 57.6589, longitude: 12.1183, displayName: 'Mölnlycke', city: 'Mölnlycke', country: 'Sweden', fetchedAt: '2024-01-01' },
	'molnlycke': { latitude: 57.6589, longitude: 12.1183, displayName: 'Mölnlycke', city: 'Mölnlycke', country: 'Sweden', fetchedAt: '2024-01-01' },
	'tollered': { latitude: 57.7167, longitude: 12.3000, displayName: 'Tollered', city: 'Tollered', country: 'Sweden', fetchedAt: '2024-01-01' },
	'älvängen': { latitude: 57.8650, longitude: 12.1100, displayName: 'Älvängen', city: 'Älvängen', country: 'Sweden', fetchedAt: '2024-01-01' },
	'alvangen': { latitude: 57.8650, longitude: 12.1100, displayName: 'Älvängen', city: 'Älvängen', country: 'Sweden', fetchedAt: '2024-01-01' },
	'lindholmen': { latitude: 57.7067, longitude: 11.9375, displayName: 'Lindholmen', city: 'Göteborg', country: 'Sweden', fetchedAt: '2024-01-01' },
	'myggenäs': { latitude: 57.9833, longitude: 11.6000, displayName: 'Myggenäs', city: 'Myggenäs', country: 'Sweden', fetchedAt: '2024-01-01' },
	'myggenas': { latitude: 57.9833, longitude: 11.6000, displayName: 'Myggenäs', city: 'Myggenäs', country: 'Sweden', fetchedAt: '2024-01-01' },
	'öckerö': { latitude: 57.7100, longitude: 11.6500, displayName: 'Öckerö', city: 'Öckerö', country: 'Sweden', fetchedAt: '2024-01-01' },
	'ockero': { latitude: 57.7100, longitude: 11.6500, displayName: 'Öckerö', city: 'Öckerö', country: 'Sweden', fetchedAt: '2024-01-01' },
	'kållekärr': { latitude: 57.9500, longitude: 11.6333, displayName: 'Kållekärr', city: 'Kållekärr', country: 'Sweden', fetchedAt: '2024-01-01' },
	'kallekarr': { latitude: 57.9500, longitude: 11.6333, displayName: 'Kållekärr', city: 'Kållekärr', country: 'Sweden', fetchedAt: '2024-01-01' },
	'gånghester': { latitude: 57.6667, longitude: 12.8000, displayName: 'Gånghester', city: 'Gånghester', country: 'Sweden', fetchedAt: '2024-01-01' },
	'ganghester': { latitude: 57.6667, longitude: 12.8000, displayName: 'Gånghester', city: 'Gånghester', country: 'Sweden', fetchedAt: '2024-01-01' },
	'slöinge': { latitude: 56.8833, longitude: 12.7833, displayName: 'Slöinge', city: 'Slöinge', country: 'Sweden', fetchedAt: '2024-01-01' },
	'sloinge': { latitude: 56.8833, longitude: 12.7833, displayName: 'Slöinge', city: 'Slöinge', country: 'Sweden', fetchedAt: '2024-01-01' },
	// Stockholm area - batch distance discoveries
	'kista': { latitude: 59.4028, longitude: 17.9447, displayName: 'Kista', city: 'Stockholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	'hägersten': { latitude: 59.2958, longitude: 18.0078, displayName: 'Hägersten', city: 'Stockholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	'hagersten': { latitude: 59.2958, longitude: 18.0078, displayName: 'Hägersten', city: 'Stockholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	'djursholm': { latitude: 59.3958, longitude: 18.0875, displayName: 'Djursholm', city: 'Djursholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	'vällingby': { latitude: 59.3631, longitude: 17.8706, displayName: 'Vällingby', city: 'Stockholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	'vallingby': { latitude: 59.3631, longitude: 17.8706, displayName: 'Vällingby', city: 'Stockholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	'östermalm': { latitude: 59.3386, longitude: 18.0889, displayName: 'Östermalm', city: 'Stockholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	'ostermalm': { latitude: 59.3386, longitude: 18.0889, displayName: 'Östermalm', city: 'Stockholm', country: 'Sweden', fetchedAt: '2024-01-01' },
	// Other Swedish cities - batch distance discoveries
	'skara': { latitude: 58.3867, longitude: 13.4388, displayName: 'Skara', city: 'Skara', country: 'Sweden', fetchedAt: '2024-01-01' },
	'ludvika': { latitude: 60.1494, longitude: 15.1878, displayName: 'Ludvika', city: 'Ludvika', country: 'Sweden', fetchedAt: '2024-01-01' },
	'örnsköldsvik': { latitude: 63.2909, longitude: 18.7152, displayName: 'Örnsköldsvik', city: 'Örnsköldsvik', country: 'Sweden', fetchedAt: '2024-01-01' },
	'ornskoldsvik': { latitude: 63.2909, longitude: 18.7152, displayName: 'Örnsköldsvik', city: 'Örnsköldsvik', country: 'Sweden', fetchedAt: '2024-01-01' },
	'kumla': { latitude: 59.1275, longitude: 15.1396, displayName: 'Kumla', city: 'Kumla', country: 'Sweden', fetchedAt: '2024-01-01' },
	'näsviken': { latitude: 61.7167, longitude: 16.2333, displayName: 'Näsviken', city: 'Näsviken', country: 'Sweden', fetchedAt: '2024-01-01' },
	'nasviken': { latitude: 61.7167, longitude: 16.2333, displayName: 'Näsviken', city: 'Näsviken', country: 'Sweden', fetchedAt: '2024-01-01' },
};
